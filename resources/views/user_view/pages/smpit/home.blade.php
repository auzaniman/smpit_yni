...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4 mb-5 mb-lg-0">
          <div class="rotating-card-container">
            <div class="card card-rotate card-background card-background-mask-success shadow-success mt-md-0 mt-5">
              <div class="front front-background" style="background-image: url(frontend/assets/img/SMPIT/3.jpeg); background-size: cover;">
                <div class="card-body py-7 text-center">
                  <i class="material-icons text-white text-4xl my-3">touch_app</i>
                  <h3 class="text-white">Jelajahi <br /> SMPIT Nurul 'Ilmi</h3>
                  <p class="text-white opacity-8">Mengenal program dan bidang SMPIT dalam pengembangan didunia pendidikan.</p>
                </div>
              </div>
              <div class="back back-background" style="background-image: url(frontend/assets/img/SMPIT/2.jpeg); background-size: cover;">
                <div class="card-body pt-7 text-center">
                  <h3 class="text-white">Jelajahi SMPIT</h3>
                  <p class="text-white opacity-8">Mengenal program dan bidang SMPIT dalam pengembangan didunia pendidikan.</p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="position-sticky pb-lg-5 pb-3 mt-lg-0 mt-5 ps-2" style="top: 100px">
            <h3>Jelajahi SMPIT Nurul 'Ilmi</h3>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Berikut adalah fasilitas SMPIT Nurul Ilmi Tenggarong.</p>
                          </div>
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-lg-6 my-auto">
                            ...
                            <p class="pe-5">Berikut adalah kegiatan Ekstra pengembangan potensi siswa SMPIT Nurul Ilmi Tenggarong.</p>
                          </div>
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="row mt-4">
            <div class="col-md-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/SMPIT/1.jpeg')}}" alt="aboutus">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-0 mt-5">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/SMPIT/2.jpeg')}}" alt="contacus">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-3 mt-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/SMPIT/3.jpeg')}}" alt="signin">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
            ...
            <div class="col-md-6 mt-md-3 mt-6">
              <a href="">
                <div class="card move-on-hover">
                  <img class="w-100" src="{{ url('frontend/assets/img/SMPIT/4.jpeg')}}" alt="author">
                </div>
                <div class="mt-2 ms-2">
                  <h6 class="mb-0">-</h6>
                </div>
        ...
        <div class="col-md-3 mx-auto mt-md-0 mt-5">
          <div class="position-sticky" style="top:100px !important">
            <h4 class="">Galeri SMPIT Nurul 'Ilmi</h4>
            <h6 class="text-secondary font-weight-normal">Bagian dari landscape kegiatan kami sekolah SMPIT Nurul 'Ilmi</h6>
          </div>
        </div>
      </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-start mb-5 mt-5">
          <h3 class="text-white z-index-1 position-relative">Guru-guru SMPIT Nurul 'Ilmi Tenggarong</h3>
  ...
  <section class="py-5 mt-5">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h3 class="mb-5">Informasi Berita SMPIT Nurul 'Ilmi</h3>
        </div>
      </div>
      <div class="row">
      ...
      <div class="container py-7 postion-relative z-index-2 position-relative">
        <div class="row">
          <div class="col-md-7 mx-auto text-center">
            <h3 class="text-white mb-0">SMPIT Nurul 'Ilmi Tenggarong</h3>
            <h3 class="text-white">Daftarkan segera putra putri anda disekolah SMPIT Nurul 'Ilmi</h3>
            ...
            <a href="https://ynikoetaikartanagara.com/ppdb/smait_create" class="btn btn-info btn-lg mb-3 mb-sm-0">Pendaftaran Online SMPIT</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-12 my-auto">
          <a href="https://www.creative-tim.com/product/material-kit-pro?ref=index-mk2">
            <img class="w-100 border-radius-lg shadow-lg" src="{{ url('frontend/assets/img/SMPIT/1.jpeg')}}" alt="Product Image">
          </a>
        </div>
      </div>
    </div>
